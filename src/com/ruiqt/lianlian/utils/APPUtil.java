...
public class APPUtil{
    ...
    private static boolean checkSignRSA(JSONObject reqObj, String rsa_public)
    {
        ...
        System.out.println("商户待签名原串"+ sign_src);
        System.out.println("商户签名串"+ sign);
        try
        {
            if (TraderRSAUtil.checksign(rsa_public, sign_src, sign))
            {
                System.out.println("商户RSA签名验证通过");
                return true;
            } else
            {
                System.out.println("商户RSA签名验证未通过");
                return false;
            }
        } catch (Exception e)
        {
            System.out.println("商户RSA签名验证异常" + e.getMessage());
            return false;
        }
    }
    ...
    {
        System.out.println("进入商户MD5签名验证");
        if (reqObj == null)
        {
            return false;
        }
        ...
        // 生成待签名串
        String sign_src = genSignData(reqObj);
        System.out.println("商户 待签名原串"
                + sign_src);
        System.out.println("商户 签名串"
                + sign);
        ...
        try
        {
            ...
            {
                System.out.println("商户MD5签名验证通过");
                return true;
            } else
            {
                System.out.println("商户MD5签名验证未通过");
                return false;
            }
        } catch (UnsupportedEncodingException e)
        {
            System.out.println("商户MD5签名验证异常" + e.getMessage());
            return false;
        }
    }
    ...
    {
        System.out.println("进入商户 RSA加签名");
        if (reqObj == null)
        {
            return "";
        }
        ...
        {
            System.out.println("商户RSA加签名异常" + e.getMessage());
            return "";
        }
    }
