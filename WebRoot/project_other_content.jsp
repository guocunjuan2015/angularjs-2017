...
<head>
  ...
  <script src="js/project_other_content.js?v=20170706" type="text/javascript"></script>
  <style>
  .globalFooter{border-top:none;}
  .swiper-slide{height:auto;}
  .closeNameOrCard{top:-12px;}
  </style>
</head>
<body>
   ...
   <div id="main">
           ...
           <!-- 详情banner部分 -->
                       <section class="project_content">
                            <p>
                              <span id="project_loanRate" ng-bind="rate"></span>
                           ...
                           <div class="poject_top">
                              <ul>
                                <li class="col-lg-4 col-ms-4 col-sm-4 col-xs-4">
                                  <p id="project_loanPeriod" ng-bind="projectPeriod"> 
                                  </p>
                                  <p class="bottom_tit" id="qixian" ng-bind="deadlineDetail"></p>
                               </li>
                              <li class="col-lg-4 col-ms-4 col-sm-4 col-xs-4">
                                  <p><span id="project_balance" ng-bind="residualAmount"></span></p> 
                                  <p class="bottom_tit">剩余金额</p>
                               </li>
                              <li class="col-lg-4 col-ms-4 col-sm-4 col-xs-4">
                                  <p><font id="project_minNum" ng-bind="totleMoney"></font></p>
                        ...
                        <section class="projectlx outter">
                              <ul>
                                 ...
                                 <li class="projectlx-lastli">
                                  ...
                                  <li>
                                    <span>起息时间</span> 
                                    <span class="projectlx-secondspan">满标计息</span>
                                  </li>
                                  <li>
                                      <span>还款方式</span>
                                      <span class="projectlx-secondspan" id="project_repaymentWay" ng-bind="paymentMethod"></span>
                                  </li>
                              </ul>
                      </section>
             ...
             <!--  <p class="checkDetails"><span></span>上拉查看详情</p> -->
             <!--项目详情start  --> 
          ...
          <div class="projectcontent">
                      ...
                      <div  class="project_infor" ng-if="isBorrowing == false">
                        <!--项目描述 start  -->
                          <div class="project_list">
                                ...
                                <p  id="type_info_p" ng-bind="projectIntro"></p>
                          </div>
                          <!--资金用途 start  -->
                          <div class="project_list">
                                <h5 class="dt_title">资金用途</h5>
                                <p  id="fin_use" ng-bind="fundPurpose"></p>
                          </div>
                      <!--还款来源 start  -->
                          <div class="project_list">
                                <h5 class="dt_title">还款来源</h5>
                                <p  id="pay_resource" ng-bind="paymentSource"></p>
                          </div>          
                      <!--证明材料 start  -->
                          <div class="project_list">
                                <h5 class="dt_title">证明材料</h5>
                                <ul>
                                    <li ng-repeat="proofUrlList in proofUrlList" class="col-lg-4 col-ms-4 col-sm-4 col-xs-4"> 
                  ...
                  <img  src="images/project_content/riskControlmg.png"/>
                     <!--还款来源 start  -->
                      ...
                      <div class="project_list" ng-if="riskUrl == ''">
                       ...
                       <div class="project_list" ng-if="riskUrl != ''">
                            <object type="text/javascript" data="{{riskUrl}}" width=100% height=100%></object>
                      </div> 
              ...
              <div class="globalFooter">
                <div>
                    <p style="text-align:center;"><button  id="investBtnNew"><!-- onclick="checkStatus()" --></button></p>
                 </div>
              </div>
        </div>
    </div>
...
<div class="evaluation">
    ...
    <p><a class="closelog" href="javascript:;">暂不评测</a><a href="<%=basePath%>/riskAssessment.jsp?reflect_url=project_other_content.jsp?id=${param.id}&projectType=${param.projectType}">立即测评</a></p>
  </div>
