...
<body>
	<div class="app-page" data-page="home">
		...
		<div class="app-content">
			<p class="app-section">Welcome to the App.js default theme. Click
				around to see what each widget looks like.</p>
	...
	<div class="app-page" data-page="buttons">
		...
		<div class="app-content">
			<div class="app-section">
				<ul class="app-list">
					<li class="app-button" onclick="clickButton()">Item 1</li>
					<li class="app-button">Item 2</li>
					<li class="app-button">Item 3</li>
				</ul>
			</div>
	...
	<script src="js/app/zepto.min.js"></script>

	<script src="js/app/swapper.js"></script>
	<script src="js/app/clickable.js"></script>
	<script src="js/app/scrollable.js"></script>
	...
	<script src="js/app/scroll-fix.js"></script>
	<script src="js/app/pages.js"></script>
	<script src="js/app/stack.js"></script>
