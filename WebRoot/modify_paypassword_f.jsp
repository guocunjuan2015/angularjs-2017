...
<body>
	<header>
		<div class="home_title">
			<a class="icon-back" href="#"></a>瑞钱宝-设定支付密码
		</div>
	</header>
		...
		<div class="licai-box">
			<table class="table">
				<tbody>
					...
					<tr>
						<td class="w30">支付密码</td>
						<td class="text-left text-muted9"><input type="password"
							class="form-control" id="p" name="p" placeholder="请输入支付密码">
						</td>
					</tr>
					<tr>
						<td class="w25"></td>
