...
<link rel="stylesheet" type="text/css" href="css/reward_choose.css">
<script src="js/jquery-1.11.2.min.js" type="text/javascript"></script>
<script src="js/utils.js" type="text/javascript"></script>
<script src="js/bootstrap.min.js" type="text/javascript"></script>
<script src="js/choose_coupon.js" type="text/javascript"></script>
<script src="js/om_code.js" type="text/javascript"></script>
</head>
<body huaban_collector_injected="true" style="background: #fff;">
	<header>
		<div class="home_title">
			<a class="icon-back" href="#"></a>我的奖励 <span class="sp_titile_right smaller-font"
				id="sp_save_use" onclick="checkCouponMax()">取消使用</span>
		</div>
	</header>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-danger btn-block" onclick="refresh()">返回</button>
				</div>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="head_2">
			<div class="tab_1 fl" onclick="changeType(1,this)">瑞钱币</div>
	...
	<div id="show_choose_div">已选择 <span id="sp_cop_count">0</span> 张 <span id="sp_cop_type"></span>,共 <span id="sp_cop_value">0.00</span> 元</div>
