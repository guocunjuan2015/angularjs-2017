...
function toRegist() {
		window.location.href = "http://www.rqbao.com/rqb/ump_register.jsp?utm_source=czwy";
}
</script>
</head>
<body>
 
<img style="width:100%; padding-bottom: 6rem;background: #fff;" src="images/activity/xmiles.png" />
