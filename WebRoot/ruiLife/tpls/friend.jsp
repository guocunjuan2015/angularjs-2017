...
<html>
	<head>
		...
		<script type="text/javascript">
			function toNextPage(obj) {
				url ='<%=basePath %>/ruiLife/friDetails.jsp?goodId=';
	...
	<body>
		<div class="view" ng-controller="FriendCtrl">
...
// 					 $('.hiSlider').hiSlider();
	 		...
	 		<section>
				<p class="all">全部</p>
				<div class="oAll_IMG" ng-repeat="rlifeGood in rLifeGoods">
					<a href="javascript:;" onclick="toNextPage(this);">
						<input type="hidden" class="rlifeGood" value="{{rlifeGood.id}}"/>
						<img src="{{rlifeGood.imgUrl}}" />
					</a>
				</div>
			</section>
		</div>
