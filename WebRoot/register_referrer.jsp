...
<script src="js/frame/my_swipe.js" type="text/javascript"></script>
<script src="js/utils.js" type="text/javascript"></script>
<script src="js/bootstrap.min3.0.3.js"></script>
<script src="js/register_referrer.js" type="text/javascript"></script>
...
<button style="display: none" id="myModal" type="button"
   ...
   <!-- 轮播（Carousel）指标 -->
   <ol class="carousel-indicators ol-position">
   ...
   <div class="carousel-inner">
      <div class="item active">
         <img src="images/reg-banner01.jpg" alt="First slide">
      </div>
      <div class="item">
         <img src="images/reg-banner02.jpg" alt="Second slide">
      </div>
       <div class="item">
         <img src="images/reg-banner03.jpg" alt="Third slide">
      </div>
      <div class="item">
         <img src="images/reg-banner05.jpg" alt="Fifth slide">
      </div>
      <div class="item">
         <img src="images/reg-banner06.jpg" alt="Sixth slide">
      </div></div>  </div>
		...
		<div class="login">
            ...
            <input data-role='none'  id="vc" name="vc"
                type="text" placeholder="图片验证码"
                 style="width: 25%;margin: 0 0 0 8%;padding: 0;"/>
		...
		<div class="login">
			<span>验证码</span><input data-role='none'  type="text" id="c" name="c"
				...
				class="btn-pin get_code" id="getc">获取验证码</button>
		</div>
        ...
        <div onclick="toLogin()" style="text-align: center;margin-top: 20px;color:#8ad2fc">去登录</div>
        <br/>
	</section>
</body>
</html>