...
function toRegist() {
	...
	if (getRequestParam("utm_source")) {
		...
		window.location.href = "http://www.rqbao.com/rqb/ump_register.jsp?utm_source="+f;
}
</script>
</head>
<body>
 
<img style="width:100%;padding-bottom:60px;" src="images/activity/cow_award/cow_award2.png" />

 <footer>
 <div><button class="btn btn-lg btn-block" onclick="toRegist()">立即投资</button></div>
 </footer>
