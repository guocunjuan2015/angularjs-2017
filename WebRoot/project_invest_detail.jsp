...
<body>
 ...
 <script>
   ...
   <!-- 主题内容显示区 -->
   <div id="main">
           <div class="swiper-slide" ng-controller="projectdetailsController">
           <!-- 详情banner部分 -->
               <section class="project_content">
                    <p><span id="project_loanRate">{{rate}}</span><font>%</font></p>
                ...
                <section class="projectlx outter">
                      <ul>
                         ...
                         <li class="projectlx-lastli deadline" style="display: none">
