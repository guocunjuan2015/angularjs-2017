...
%>
	...
	<body class="toRight">
       ...
       <input type="hidden" value="<%=localPath%>"  id="localPath">
    	<!-- <div id="toper">
          	<img  class="topImageL" src="images/topLogo.png"/>
          	<div>瑞钱宝 <img src="images/star.png"/> <img src="images/star.png"/> <img src="images/star.png"/> <img src="images/star.png"/> <img src="images/star.png"/>
              <p>下载APP，理财更方便</p>                      
          	</div>
          	<span><img onclick="closeBtn();"  src="images/closeBtn.png"/></span>
    	</div>
		<header class="register_top">
      	...
      	<section class="activetyBannner">
        	<img src="images/ump_activetyBannner.png"/>
      	</section>
        	...
        	<div class="regbg">
        		<div class="regbgRepeat clearfix">
        			<div class="fl toper">
        				...
        				<p><b>7</b>%</p>
        				<p>预期年化收益</p>
        				<p><input type="button" value="立即投资"></p>
        			</div>
        			<div class="fl toper">
        				<p>90天</p>
        				<p><b>8</b>%</p>
        ...
        <img class="" src="images/ump_activetyTitle2.png" alt="平台优势"/>
        <section class="productAdvantage">
        	<div class="regbg">
        		<div class="regbgRepeat clearfix">
              <div class="ptys">
        ...
        <footer>
        	...
        	<p>市场有风险  投资需谨慎</p>
        	<div class="regtel"><span>客服电话：<a href="tel:400-919-8555">400-919-8555</a></span></div>
        </footer>
