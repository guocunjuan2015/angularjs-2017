...
<button style="display: none" id="myModal" type="button"
                        ...
                        <tr>
                            <td>
                                <button type="button" data-dismiss="modal" 
                                    id="bt_invite" class="btn btn-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;取  消&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                            </td>
                            <td><button type="button" data-dismiss="modal"
                                    onclick="sendRadioCode(2)" id="bt_to_invest"
                                    class="btn btn-danger">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;接  收&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></td>
                        </tr>
                    </table>
                </div>
            </div>
	...
	<section class="bank-details">
		...
		<ul>
			<li><span class="menus"> 手机号 </span><input id="new_tel"
				type="tel" style="border: none" placeholder="输入新手机号"
				onkeyup="clearError()" /></li>
			<li><span class="menus"> 验证码 </span><input type="text" id="new_code"
				placeholder="短信验验证码" onkeyup="clearError()" /><button class="get_code"
				id="getc" onclick="getCode(2)">获取验证码</button></li>
			<li id="no_accept_code"><div onclick="getRadioCode(2)">没有收到验证码</div></li>
		</ul>

		<div style="margin: 0 15px;">
			<button type="button" class="btn btn-lg btn-danger btn-block "
				id="btn_modify" onclick="modifyStep2()">确认</button>
		</div>
	</section>
