...
<section>
        <h1 class="home_title red_bg">
            ...
            <span class="sp_titile_left" onclick="showBg()">说明</span>
        </h1>
    </section>
<section class="invert-info" style="margin-top:0;">
    ...
    <!-- <button class="btn btn-lg btn-block btn-look-invert btn-bg-grey">删除</button> -->
...
<script type="text/javascript" src="js/auto_invest_edit.js"></script>
