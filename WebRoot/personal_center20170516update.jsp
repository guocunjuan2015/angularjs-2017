...
<%@ include file="/config/globalHead.jsp" %>
  ...
  <div class="realName">
    <h3>欢迎来到瑞钱宝</h3>
    <p>请对您的账户进行实名认证</p>
    <p><a class="closeName" href="javascript:;">取消</a><a href="javascript:;" onclick="gotoPage(14)">去实名</a></p>
  </div>
  <!--实名或者绑卡start  -->
  <div class="realNameOrCard">
    <h3>欢迎来到瑞钱宝</h3>
    <p>开通银行存管，让您的资金更安全</p>
    <p><a class="closeNameOrCard" href="javascript:;">取消</a><a href="javascript:;" onclick="gotoPage(14)">去开通</a></p>
  </div>
   <!--实名或者绑卡end  -->
  <div class="tieOnCard">
    <h3>温馨提示</h3>
    <p>请先绑定银行卡，再进行资金交易</p>
    <p><a class="closeCard" href="javascript:;">取消</a><a href="javascript:;" onclick="gotoPage(15)">去绑卡</a></p>
  </div>
  <%--头像 --%>
