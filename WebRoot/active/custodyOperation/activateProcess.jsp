     ...
     <div class="swiper-container swiper-container-horizontal">
        <div class="swiper-wrapper">
		            <div class="swiper-slide swiper-slide-active">
		                ...
		                <p class="step step1">第一步：点击充值、投资、绑卡、提现等任一操作，出现提示开户页面，点击［开通存管账户]</p>
		          </div>  
             <!-- 激活流程  -->
			            <div class="swiper-slide swiper-slide-next">
			                ...
			                <div class="swiperImg">
			                 ...
			                 <p class="step step2">第二步：点击充值、投资、绑卡、提现等任一操作，出现提示开户页面，点击［开通存管账户]</p>
            </div>
            <!-- 充值流程  -->
		            <div class="swiper-slide">
		               <div class="title">充值流程</div>
		                ...
		                <p class="step step3">第二步：点击充值、投资、绑卡、提现等任一操作，出现提示开户页面，点击［开通存管账户]</p>
		        </div>    
             <!-- 投资流程  -->
	            <div class="swiper-slide">
	               <div class="title">投资流程</div>
	                ...
	                <div class="swiperImg">
	                 ...
	                 <p class="step step4">第二步：点击充值、投资、绑卡、提现等任一操作，出现提示开户页面，点击［开通存管账户]</p>
	          </div>  
            <!-- 提现流程  -->
		      <div class="swiper-slide">
		               <div class="title">提现流程</div>
		                ...
		                <div class="swiperImg">
		                 ...
		                 <p class="step step5">第二步：点击充值、投资、绑卡、提现等任一操作，出现提示开户页面，点击［开通存管账户]</p>
		         </div>   
        </div>
        <!-- Add Pagination -->
