...
<head>
  ...
  <style>
     .custodyProcessStep li:first-child +li+li{background:#0473EE;} 
  </style>
</head>
     ...
     <div class="swiper-container swiper-container-horizontal">
        <div class="swiper-wrapper">
		            <div class="swiper-slide swiper-slide-active">
		                ...
		                <p class="step step1">第一步：在瑞钱宝账户中心，点击［充值］。</p>
		          </div>  
             <!-- 激活流程  -->
			            <div class="swiper-slide swiper-slide-next">
			                ...
			                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
			                <div class="swiperImg">
			                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process7.png"></p>
			                </div>
			                 <p class="step step2">第二步：输入充值金额，点击［下一步］。</p>
            </div>
            <!-- 充值流程  -->
		            <div class="swiper-slide">
		               <div class="title">充值流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process8.png"></p>
		                </div>
		                <p class="step step3">第三步：输入六位数交易密码，点击［确认充值］。</p>
		        </div>    
             <!-- 投资流程  -->
	            <div class="swiper-slide">
	               <div class="title">充值流程</div>
	                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
	                <div class="swiperImg">
	                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process9.png"></p>
	                </div>
	                 <p class="step step4">第四步：获取短信验证码，点击［立即充值］。</p>
	          </div>  
            <!-- 提现流程  -->
		      <div class="swiper-slide">
		               <div class="title">充值流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process10.png"></p>
		                </div>
		                 <p class="step step5">第五步：充值成功。</p>
		         </div>   
        </div>
        <!-- Add Pagination -->
