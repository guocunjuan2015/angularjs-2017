...
<head>
  ...
  <style>
     .custodyProcessStep li:first-child +li+li+li{background:#0473EE;} 
  </style>
</head>
     ...
     <div class="swiper-container swiper-container-horizontal">
        <div class="swiper-wrapper">
		            <div class="swiper-slide swiper-slide-active">
		                ...
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process14.png"></p>
		                </div>
		                <p class="step step1">第一步：输入投资金额，点击［投资］。</p>
		          </div>  
             <!-- 激活流程  -->
			            <div class="swiper-slide swiper-slide-next">
			                ...
			                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
			                <div class="swiperImg">
			                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process15.png"></p>
			                </div>
			                 <p class="step step2">第二步：输入交易密码，点击［确认］。</p>
            </div>
            <!-- 充值流程  -->
		            <div class="swiper-slide">
		               <div class="title">投资流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process16.png"></p>
		                </div>
		                <p class="step step3">第三步：投资成功。</p>
		        </div>    
        </div>
        <!-- Add Pagination -->
