...
<head>
  ...
  <style>
     .custodyProcessStep li:first-child +li{background:#0473EE;} 
  </style>
</head>
<body>
     ...
     <div class="swiper-container swiper-container-horizontal">
        <div class="swiper-wrapper">
		            <div class="swiper-slide swiper-slide-active">
		                <div class="title">开户流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process1.png"></p>
		                </div>
		                <p class="step step1">第一步：登录瑞钱宝账户中心，出现提示开户弹窗，点击［立即开通］</p>
		          </div>  
             <!-- 激活流程  -->
			            <div class="swiper-slide swiper-slide-next">
			                ...
			                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
			                <div class="swiperImg">
			                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process2.png"></p>
			                </div>
			                 <p class="step step2">第二步：在海口联合农商银行，点击［开通存管账户］。</p>
            </div>
            <!-- 充值流程  -->
		            <div class="swiper-slide">
		               <div class="title">开户流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process3.png"></p>
		                </div>
		                <p class="step step3">第三步：输入用户信息，点击［下一步］。</p>
		        </div>    
             <!-- 投资流程  -->
	            <div class="swiper-slide">
	               <div class="title">开户流程</div>
	                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
	                <div class="swiperImg">
	                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process4.png"></p>
	                </div>
	                 <p class="step step4">第四步：设置交易密码，用于充值、投资、提现等环节，点击［同意以下协议并开通］。</p>
	          </div>  
            <!-- 提现流程  -->
		      <div class="swiper-slide">
		               <div class="title">开户流程</div>
		                <div class="subtitle">部分数据已同步至海口联合农商银行</div>
		                <div class="swiperImg">
		                    <p><img alt="" src="${pageContext.request.contextPath}/active/custodyOperation/image/process5.png"></p>
		                </div>
		                 <p class="step step5">第五步：银行存管账户开通成功。</p>
		         </div>   
        </div>
        <!-- Add Pagination -->
