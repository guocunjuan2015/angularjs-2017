...
<head>
  ...
  <link href="${pageContext.request.contextPath}/active/coolSummer/coolSummer.css" rel="stylesheet">
  ...
  <script> 
    /*标题 */
    function showShare(){
        IOSModel.changeWebTitle("清凉一夏");
      }
    $(function(){
        title = "依国企华融天泽背景，坐享稳健收益，欢迎投资瑞钱宝";
        content 
        = "瑞钱宝—大型国企参股，多种优质项目，让您轻松理财！";
      icon = "<%=basePath %>/images/logo/coolSummer.png";
      url  = "<%=basePath %>/active/coolSummer/coolSummer.jsp?from=app&utm_source=<%=utm_source %>";
      _url = "<%=basePath %>/active/coolSummer/coolSummer.jsp?from=app&utm_source=<%=utm_source %>";
       // getReferenceRank();
      /*分享好友*/
...
<body style="background:#f7e9bc;">
  ...
  <input type="hidden" value="" id="code"/>
       <img alt="" src="${pageContext.request.contextPath}/active/coolSummer/banner.png">
